        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="max-w-2xl">
                <div class="flex items-center gap-3 mb-6">
                    <Link :href="route('admin.users.index')" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300" aria-label="Back to users">
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        <div class="grid grid-cols-2 gap-3">
                            <FormField label="First Name" label-class="text-sm mb-1" :error="form.errors.first_name" v-slot="field">
                                <input v-bind="field" v-model="form.first_name" type="text" required
                        ...
                        <FormField label="Confirm Password" label-class="text-sm mb-1" :error="form.errors.password_confirmation" v-slot="field">
                            <input v-bind="field" v-model="form.password_confirmation" type="password" required
                                autocomplete="new-password" class="ui-input" />
                        </FormField>

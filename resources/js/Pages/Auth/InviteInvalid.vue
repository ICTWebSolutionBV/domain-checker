...
<template>
    ...
    <div
        class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900 px-4"
    >
        <div class="w-full max-w-sm text-center">
            ...
            <Link :href="route('login')" class="ui-btn ui-btn-primary px-5"> Go to sign in </Link>
        </div>
    </div>
</template>
